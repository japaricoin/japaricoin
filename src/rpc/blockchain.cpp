...
UniValue gettxout(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of servalcoin addresses\n"
...
UniValue getblockchaininfo(const JSONRPCRequest& request)
{
    ...
    softforks.push_back(SoftForkDesc("csv", 4, tip, consensusParams));
    softforks.push_back(SoftForkDesc("segwit", 4, tip, consensusParams));
